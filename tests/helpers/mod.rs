...
impl<const TOKEN_COUNT: usize> TestPoolAccountInfo<TOKEN_COUNT> {
    ...
    pub async fn prepare_accounts_for_swap_exact_input(
        &self,
        banks_client: &mut BanksClient,
        payer: &Keypair,
        user_accounts_owner: &Keypair,
    ...
    pub async fn prepare_accounts_for_swap_exact_output(
        &self,
        banks_client: &mut BanksClient,
        payer: &Keypair,
        user_accounts_owner: &Keypair,
        ...
        approve_delegate(
            ...
            payer,
            &recent_blockhash,
            &user_token_account_pubkeys[input_token_index],
            user_transfer_authority,
            user_accounts_owner,
